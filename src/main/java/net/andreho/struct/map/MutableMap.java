...
public interface MutableMap<K, V>
    ...
    * @return
    */
   static <K, V> MutableMap<K, V> linearProbingMap() {
    ...
    * @return
    */
   static <K, V> MutableMap<K, V> linearProbingMap(int capacity) {
    ...
    * @return
    */
   static <K, V> MutableMap<K, V> linearProbingMap(Map<? extends K, ? extends V> map) {
      return new LinearProbingHashMap<>(map);
   }
    ...
    * @return
    */
   static <K, V> MutableMap<K, V> linearProbingMap(ImmutableMap<? extends K, ? extends V> map) {
      return new LinearProbingHashMap<>(map);
   }
    ...
    * @return
    */
   default V putWith(K key, Function<K,V> extractor) {
      return put(key, extractor.apply(key));
   }
